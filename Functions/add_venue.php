<?php 
  ...
  if(isset($_POST['add'])){
    ...
    assert(!empty($id), 'Id is empty');

    // Assert that the cno is not empty
    assert(!empty($cno), 'Course no is empty');

    // Assert that the courses is not empty
    assert(!empty($courses), 'Courses is empty');

    // Assert that the venue is not empty
    assert(!empty($venue), 'Venue is empty');

    // Assert that the floor is not empty
    assert(!empty($floor), 'Floor is empty');

    // Assert that the img is not empty
    assert(!empty($img), 'Venue Map is empty');
