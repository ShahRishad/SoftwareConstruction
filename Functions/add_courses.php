<?php 
  ...
  if(isset($_POST['add'])){
     ...
     // Assert that all input fields are not empty
    assert(!empty($time), "Time cannot be empty");
    assert(!empty($course_o1), "Course 1 cannot be empty");
    assert(!empty($course_o2), "Course 2 cannot be empty");
    assert(!empty($course_o3), "Course 3 cannot be empty");
    assert(!empty($course_o4), "Course 4 cannot be empty");
    assert(!empty($course_o5), "Course 5 cannot be empty");
    assert(!empty($course_o6), "Course 6 cannot be empty");
    assert(!empty($course_o7), "Course 7 cannot be empty");
    assert(!empty($course_o8), "Course 8 cannot be empty");
    assert(!empty($course_o9), "Course 9 cannot be empty");
