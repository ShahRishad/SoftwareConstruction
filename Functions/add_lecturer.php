<?php 
  ...
  if(isset($_POST['add'])){
    ...
    assert(!empty($id), "ID cannot be empty");
    assert(!empty($lno), "LNO cannot be empty");
    assert(!empty($lecturer_name), "Lecturer name cannot be empty");
    assert(!empty($phone), "Phone number cannot be empty");
    assert(!empty($office), "Office cannot be empty");
    assert(!empty($email), "Email cannot be empty");
    assert(!empty($picture), "Picture cannot be empty");
